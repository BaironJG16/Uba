...
<header class="header">
	...
	<div class="text-box">
		<h1 class="heading-primary">
			<span class="heading-primary-main">Bienvenido/a a tu inventario</span>
			<span class="heading-primary-sub">Aquí podrás llevar control de tus artículos</span>
		</h1>
		<a href="kj" class="btn btn-white btn-animated">Discover our tours</a>
	</div>
</header>
